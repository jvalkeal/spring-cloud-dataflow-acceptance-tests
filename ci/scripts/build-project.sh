...
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_URL=https://xxx.cf-app.com
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_ORG=xxx
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_SPACE=test
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_DOMAIN=xxx.cf-app.com
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_USERNAME=admin
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_PASSWORD=xxx
...
export TRUST_CERTS=xxx.cf-app.com
