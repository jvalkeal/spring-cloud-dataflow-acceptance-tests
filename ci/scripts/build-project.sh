...
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_URL=$CF_API_URL
export SPRING_CLOUD_DEPLOYER_CLOUDFOUNDRY_DOMAIN=$CF_API_DOMAIN
export TRUST_CERTS=$CF_API_ADDRESS
